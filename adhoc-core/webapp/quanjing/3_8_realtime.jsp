...
<jsp:include    page="navi.jsp"    flush="true">   
 	...
 	<h2>分时数据/<a style="color:#551890" href="././3_8_realtime_sum.jsp">累计数据</a>/<a style="color:#551890" href="././3_8_realtime_sumday.jsp">活动期累计数据</a>/<a style="color:#551890" href="././3_8_table.jsp">离线数据</a></h2>
...
<script  type="text/javascript" language="JavaScript" src="./3_8_realtime_fn.js" charset="utf-8"></script>
<script  type="text/javascript" language="JavaScript" src="./3_8_realtime_new.js" charset="utf-8"></script>
<script  type="text/javascript" language="JavaScript" src="./3_8_realtime.js" charset="utf-8"></script>
...
function makeDataSet()
{
		...
		labelName["suv"]="0";
		labelName["sclick"]="0";
		labelName["sclickuv"]="0";
		labelName["lead_click"]="0";
		labelName["lead_click_uv"]="0";
		labelName["call_client_pv"]="0";
		labelName["call_client_uv"]="0";
		labelName["download_client_pv"]="0";
		labelName["download_client_uv"]="0";
