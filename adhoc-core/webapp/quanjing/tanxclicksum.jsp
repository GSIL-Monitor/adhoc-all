...
<jsp:include    page="navi.jsp"    flush="true">   
	...
	<h2><a style="color:#551890" href="./tanxpv.jsp">pv</a>/<a style="color:#551890" href="./tanxclick.jsp">点击</a>/<a style="color:#551890" href="./tanxrate.jsp">点击率</a>/<a style="color:#551890" href="./tanxpvsum.jsp">pv累积</a>/点击累积/<a style="color:#551890" href="./tanxratesum.jsp">累积点击率</a>/<a style="color:#551890" href="./tanxdiff.jsp">波动</a></h2>
...
function makeDataSet()
{
				...
				g_result['click_today_sum']['ischoose']="1";
				g_result['clickbefore1_sum']['ischoose']="1";
				g_result['clickbefore7_sum']['ischoose']="1";
				g_result['click_avg_sum']['ischoose']="1";
		 datasets ={
		 	"zeroarr":g_result['zeroarr'],
		 	"click_today_sum":g_result['click_today_sum'],
		 	"clickbefore1_sum":g_result['clickbefore1_sum'],
		 	"clickbefore7_sum":g_result['clickbefore7_sum'],
		 	"click_avg_sum":g_result['click_avg_sum'],
...
function searchData(strtype,pidlist)
{
 	...
 	typeshow=["click_today","clickbefore1","clickbefore7","click_avg"];
...
logparams["set"]="全景监控tanxclicksum";
