...
<h2><a style="color:#551890" href="./tanxpv.jsp">pv</a>/<a style="color:#551890" href="./tanxclick.jsp">点击</a>/<a style="color:#551890" href="./tanxrate.jsp">点击率</a>/<a style="color:#551890" href="./tanxpvsum.jsp">pv累积</a>/<a style="color:#551890" href="./tanxclicksum.jsp">点击累积</a>/<a style="color:#551890" href="./tanxratesum.jsp">累积点击率</a>/波动</h2>
...
function makeDataSet()
{
				...
				g_result['pv_diff_rate']['ischoose']="1";
				g_result['click_diff_rate']['ischoose']="1";
		 datasets ={
		 	"zeroarr":g_result['zeroarr'],
		 	"pv_diff_rate":g_result['pv_diff_rate'],
		 	"click_diff_rate":g_result['click_diff_rate']
		 	};
...
function searchData(strtype,pidlist)
{
 	...
 	typeshow=["pv_today","pv_avg","click_today","click_avg"];
