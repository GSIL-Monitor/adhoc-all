...
<jsp:include    page="navi.jsp"    flush="true">   
             <jsp:param    name="currpage"    value="tanxpv.jsp"    />   
</jsp:include>

	<h2><a style="color:#551890" href="./tanxpv.jsp">pv</a>/<a style="color:#551890" href="./tanxclick.jsp">点击</a>/<a style="color:#551890" href="./tanxrate.jsp">点击率</a>/<a style="color:#551890" href="./tanxpvsum.jsp">pv累积</a>/<a style="color:#551890" href="./tanxclicksum.jsp">点击累积</a>/累积点击率/<a style="color:#551890" href="./tanxdiff.jsp">波动</a></h2>
...
function makeDataSet()
{
				...
				g_result['today_clickrate_sum']['ischoose']="1";
				g_result['pvbefore1_clickrate_sum']['ischoose']="1";
				g_result['pvbefore7_clickrate_sum']['ischoose']="1";
				g_result['avg_clickrate_sum']['ischoose']="1";
		 datasets ={
		 	"zeroarr":g_result['zeroarr'],
		 	"today_clickrate_sum":g_result['today_clickrate_sum'],
		 	"pvbefore1_clickrate_sum":g_result['pvbefore1_clickrate_sum']
		 	,"pvbefore7_clickrate_sum":g_result['pvbefore7_clickrate_sum']
		 	,"avg_clickrate_sum":g_result['avg_clickrate_sum']
		 	};
...
function searchData(strtype,pidlist)
{
	...
	requestClick_AVG(strtype,pidlist,"click_avg","七日平均点击","click",0);
	requestClick(strtype,pidlist,0,"click_today","当日点击","click",0);
	requestClick(strtype,pidlist,1,"clickbefore1","昨日点击","click",0);
	requestClick(strtype,pidlist,7,"clickbefore7","上周同日点击","click",0);
}
