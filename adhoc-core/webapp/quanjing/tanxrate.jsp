...
<jsp:include    page="navi.jsp"    flush="true">   
	...
	<h2><a style="color:#551890" href="./tanxpv.jsp">pv</a>/<a style="color:#551890" href="./tanxclick.jsp">点击</a>/点击率/<a style="color:#551890" href="./tanxpvsum.jsp">pv累积</a>/<a style="color:#551890" href="./tanxclicksum.jsp">点击累积</a>/<a style="color:#551890" href="./tanxratesum.jsp">累积点击率</a>/<a style="color:#551890" href="./tanxdiff.jsp">波动</a></h2>
...
function makeDataSet()
{
				...
				g_result['today_clickrate']['ischoose']="1";
				g_result['pvbefore1_clickrate']['ischoose']="1";
				g_result['pvbefore7_clickrate']['ischoose']="1";
				g_result['avg_clickrate']['ischoose']="1";
		 datasets ={
		 	"zeroarr":g_result['zeroarr'],
		 	"today_clickrate":g_result['today_clickrate'],
		 	"pvbefore1_clickrate":g_result['pvbefore1_clickrate']
		 	,"pvbefore7_clickrate":g_result['pvbefore7_clickrate']
		 	,"avg_clickrate":g_result['avg_clickrate']
		 	};
