...
<jsp:include    page="navi.jsp"    flush="true">   
	...
	<h2><a style="color:#551890" href="./tanxpv.jsp">pv</a>/点击/<a style="color:#551890" href="./tanxrate.jsp">点击率</a>/<a style="color:#551890" href="./tanxpvsum.jsp">pv累积</a>/<a style="color:#551890" href="./tanxclicksum.jsp">点击累积</a>/<a style="color:#551890" href="./tanxratesum.jsp">累积点击率</a>/<a style="color:#551890" href="./tanxdiff.jsp">波动</a></h2>
...
function makeDataSet()
{
				...
				g_result['click_today']['ischoose']="1";
				g_result['clickbefore1']['ischoose']="1";
				g_result['clickbefore7']['ischoose']="1";
				g_result['click_avg']['ischoose']="1";
		 datasets ={
		 	"zeroarr":g_result['zeroarr'],
		 	"click_today":g_result['click_today'],
		 	"clickbefore1":g_result['clickbefore1'],
		 	"clickbefore7":g_result['clickbefore7'],
		 	"click_avg":g_result['click_avg']
		 	};
